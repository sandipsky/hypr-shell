...
DEPS=(gcc pkgconf meson ninja glib2 glib2-devel gtk4 gtk4-layer-shell gtkmm-4.0 nlohmann-json libpulse libadwaita wayland wayland-protocols pam libxcrypt accountsservice)
