...
| `HS_UI_FONT_SIZE=<pt>` | Settings app, User interface page: set the Font size row after 1.5 s — this writes the **system** font (gsettings `font-name` + `gtk-{3,4}.0/settings.ini`); back them up and restore |
