...
void LauncherWindow::add_settings_results(const std::string& query) {
    ...
    static constexpr Entry kIndex[] = {
        ...
        {"CPU module", "Bar › CPU", "cpu"},
        {"CPU percentage text", "Bar › CPU", "cpu"},
        {"Memory module", "Bar › Memory", "memory"},
        {"Memory percentage text", "Bar › Memory", "memory"},
        {"Disk module", "Bar › Disk", "disk"},
        {"Disk mount point", "Bar › Disk", "disk"},
        ...
        {"User interface", "User interface", "ui_page"},
        {"Dark mode", "User interface", "ui_page"},
        {"Accent colour", "User interface", "ui_page"},
        {"Theme", "User interface", "ui_page"},
        {"Font", "User interface", "ui_page"},
        {"Font size", "User interface", "ui_page"},
        {"Icon theme", "User interface", "ui_page"},
        {"Cursor theme", "User interface", "ui_page"},
        {"Cursor size", "User interface", "ui_page"},
        ...
        {"Desktop menu", "Desktop menu", "desktop_menu_page"},
        {"Desktop context menu", "Desktop menu", "desktop_menu_page"},
        {"Right click menu items", "Desktop menu", "desktop_menu_page"},
        {"Keyboard shortcuts overlay", "Desktop menu", "desktop_menu_page"},
        ...
        {"Clipboard history", "Clipboard", "clipboard_page"},
        {"Clipboard show images", "Clipboard", "clipboard_page"},
        ...
        {"User accounts", "Users", "users_page"},
        {"Add user", "Users", "users_page"},
        {"Change password", "Users", "users_page"},
        {"Profile picture", "Users", "users_page"},
